...
class OrderAdapter(private val context: Context,private val list: List<Orders>):Adapter<OrderAdapter.MyHolder>() {
    ...
    override fun onBindViewHolder(holder: MyHolder, position: Int) {
        ...
        val prixUnitaire = orders.total.toDouble()/orders.qty.toDouble()
        holder.binding.qty.text = orders.qty+" x "+prixUnitaire+ " "+dbHelper.getShopDevise()
